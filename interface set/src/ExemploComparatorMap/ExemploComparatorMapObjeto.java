...
public class ExemploComparatorMapObjeto {
    public static void main(String[] args) {
        ...
        System.out.println("Duração da Disciplina: ");
        ...
        Set<Map.Entry<Disciplina, Aluno>> set1 = new TreeSet<Map.Entry<Disciplina, Aluno>>(new ComparatorMatriculaDoAluno());
...
class ComparatorMatriculaDoAluno implements Comparator<Map.Entry<Disciplina, Aluno>> {
    @Override
    public int compare(Map.Entry<Disciplina, Aluno> al1, Map.Entry<Disciplina, Aluno> al2) {
